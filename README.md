...
5. Assemble the dust sensor as shown in the image below
![Wiring](https://github.com/demogorgi/SDS011-Android/blob/main/Wiring.jpg)
and connect the USB plug with a power bank
6. In Qpython 3L choose Programs > projects > SDS011-Android-main > Run
7. Should look like this then: ![Screenshot WebApp](https://github.com/demogorgi/SDS011-Android/blob/main/Screenshot_QPython%203L.jpg)
